...
import com.yuriibezpalko.resource.VideoGameResource;
...
public class AppResourceConfig extends ResourceConfig {
    ...
    public AppResourceConfig() {
        ...
        packages("in.yuriibezpalko.resource", "in.yuriibezpalko.app");
    ...
    private void configureSwagger() {
        ...
        beanConfig.setDescription("https://github.com/yuriibezpalko/VideoGameDB");
        beanConfig.getSwagger().addConsumes(MediaType.APPLICATION_JSON);
        beanConfig.getSwagger().addProduces(MediaType.APPLICATION_JSON);
        beanConfig.setContact("Yurii Bezpalko");
        beanConfig.setResourcePackage("com.yuriibezpalko.resource");
